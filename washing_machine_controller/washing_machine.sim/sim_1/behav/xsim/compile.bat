...
REM
REM Generated by Vivado on Fri Jun 19 05:19:59 +0530 2026
...
echo "xvlog --incr --relax -prj tb_washing_machine_controller_vlog.prj"
call xvlog  --incr --relax -prj tb_washing_machine_controller_vlog.prj -log xvlog.log
